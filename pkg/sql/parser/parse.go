...
var errBitLengthNotPositive = errors.WithCandidateCode(
...
var errFloatPrecAtLeast1 = errors.WithCandidateCode(
	errors.New("precision for type float must be at least 1 bit"), pgcode.InvalidParameterValue)
var errFloatPrecMax54 = errors.WithCandidateCode(
