...
// it can be removed when 19.1 is outphased and the "SafeDetail"
// field is removed.
...
// are modified to use the errors package directly.
var DangerousStatementf func(format string, args ...interface{}) error = errors.DangerousStatementf
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var UnimplementedWithIssuef func(issue int, format string, args ...interface{}) error = errors.UnimplementedWithIssuef
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var UnimplementedWithIssue func(issue int, msg string) error = errors.UnimplementedWithIssue
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var UnimplementedWithIssueDetail func(issue int, detail, msg string) error = errors.UnimplementedWithIssueDetail
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var UnimplementedWithIssueDetailf func(issue int, detail, format string, args ...interface{}) error = errors.UnimplementedWithIssueDetailf
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var UnimplementedWithIssueHint func(issue int, msg, hint string) error = errors.UnimplementedWithIssueHint
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var Unimplemented func(feature, msg string) error = errors.Unimplemented
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var Unimplementedf func(feature, format string, args ...interface{}) error = errors.Unimplementedf
...
// TODO(knz): this alias exists as a transition until the callers
// are modified to use the errors package directly.
var UnimplementedWithDepthf func(depth int, feature, format string, args ...interface{}) error = errors.UnimplementedWithDepthf
