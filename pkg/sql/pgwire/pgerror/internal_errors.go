...
var AssertionFailedf func(format string, args ...interface{}) error = errors.AssertionFailedf

// AssertionFailedWithDepthf creates an internal error.
//
// TODO(knz): this function exists as a transition until the callers
// are modified to use the errors package directly.
var AssertionFailedWithDepthf func(depth int, format string, args ...interface{}) error = errors.AssertionFailedWithDepthf

// NewAssertionErrorWithWrappedErrf creates an internal error
// and attaches (but masks) the provided error cause.
var NewAssertionErrorWithWrappedErrf func(err error, format string, args ...interface{}) error = errors.NewAssertionErrorWithWrappedErrf
